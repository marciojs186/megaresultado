...
export default function Mega(){
  ...
  return(
    ...
    <View style={styles.ViewMega}>
      ...
      <View style={{flex: 10}}>
      <Animatable.Text 
      style={styles.txtAddView}
      animation = 'flipInX'
      duration={1500}
      >ADICIONAR</Animatable.Text>
      </View>
    </View>
    ...
    <View style={styles.flat}>
        ...
        <View style={{marginTop: 5}}>
            ...
            <TextInput style={styles.Input} onChangeText={(texto) => setConcurso(texto)} value={concurso} keyboardType='numeric'></TextInput>
